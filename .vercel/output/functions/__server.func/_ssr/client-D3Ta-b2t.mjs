...
import { c as getBaseURL, o as GENERIC_OAUTH_ERROR_CODES, r as cn, s as PACKAGE_VERSION } from "./router-Cvjey6fZ.mjs";
import { a as atom, i as onSet, n as STORE_UNMOUNT_DELAY, r as onMount, t as listenKeys } from "../_libs/nanostores.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/client-D3Ta-b2t.js
...
var buttonVariants = cva("inline-flex items-center justify-center gap-2 rounded-sm font-medium transition-[opacity,transform,background-color,box-shadow] duration-150 ease-out active:not-disabled:scale-[0.96] disabled:opacity-40 disabled:pointer-events-none focus-visible:outline-none focus-visible:shadow-[0_0_0_2px_var(--color-bg),0_0_0_4px_var(--color-primary)]", {
	variants: {
		variant: {
			primary: "bg-primary text-primary-fg hover:opacity-90",
			ghost: "bg-transparent text-fg shadow-[0_0_0_1px_var(--color-border)] hover:bg-elevated",
